...
class Transformer_DualAttn_multi(nn.Module):
    ...
    def forward(self, x, instruction, this_task_info=None, label=None, cam_label=None, view_label=None, forzen=False):
        ...
        if self.net_config.attn_type=='dual_attn':
            bio_fusion, clot_fusion = self.dual_attn(b1_feat, clot_feats)
            bio_fusion_1, clot_fusion_1 = self.dual_attn(b1_local_feat, clot_feats)
            bio_fusion_2, clot_fusion_2 = self.dual_attn(b2_local_feat, clot_feats)
            bio_fusion_3, clot_fusion_3 = self.dual_attn(b3_local_feat, clot_feats)
            bio_fusion_4, clot_fusion_4 = self.dual_attn(b4_local_feat, clot_feats)
