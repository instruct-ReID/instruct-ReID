...
class DataBuilder_cc(object):
    def __init__(self, args, task_info=None):
        ...
        _, self.transform_clip = clip.load('./logs/pretrain_weights/ViT-B-32.pt', device='cuda', jit=False)
    ...
    def _build_train_loader(self, dataset):
        ...
        train_loader = DataLoader(PreProcessor(dataset, root=data_root,
                                               ...
                                               clothes_transform=self.transform_clip, blur_clo=self.args.pool_clo),
